package com.andrinotech.ustadapp.FragNav;
...
/**
 * Created by AhadAs on 4/12/2018.
 */
...
public class FragNavController {
    ...
    FragNavTransactionOptions fragNavTransactionOptions = FragNavTransactionOptions.newBuilder().customAnimations(android.R.anim.slide_in_left, android.R.anim.slide_out_right, android.R.anim.slide_in_left, android.R.anim.slide_out_right).build();
